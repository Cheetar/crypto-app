...
urlpatterns = [
    ...
    path("edit_js_cipher/<int:cipher_id>", views.edit_js_cipher),
    ...
    path("execute_js_cipher/<int:cipher_id>", views.execute_js_cipher),
    path("execute_cpp_cipher/<int:cipher_id>", views.execute_cpp_cipher),
